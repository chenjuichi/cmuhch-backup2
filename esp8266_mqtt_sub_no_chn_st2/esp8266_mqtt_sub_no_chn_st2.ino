...
void mqttCallback(char* topic, byte* payload, unsigned int length) {
  ...
  if (str_msg.equals("on")) {           // 如果收到的訊息為"on"
    ...
    //Serial.println("Station2/Layout1/Led5 LED ON");
    ledFlash = false;
    String strLed(" station2/");        // 初始化字串
    ...
    //Serial.println("station2/Layout1/Led5 LED OFF");
    ledFlash = false;
    String strLed(" station2/");        // 初始化字串
